...
const PregnancyCardViewMidwife = () => {
  ...
  return (
    <div className="form-container">
      <h1 className="form-title" style={{ color: ' #B3817A' }}>Pregnancy Record - Read-Only View</h1>
      ...
      {currentPage === 1 && (
        <div>
          ...
          <div className="btn-container">
            <button type="button" className="btn-primary" style={{ backgroundColor: ' #e19c93' }} onClick={handleNextPage}>Next</button>
          </div>
        </div>
      )}
      ...
      {currentPage === 2 && (
        <div>
          ...
          <div className="btn-container">
            <button type="button" className="btn-primary" style={{ backgroundColor: ' #e19c93' }}  onClick={handlePreviousPage}>Back</button>
            <button type="button" className="btn-primary" style={{ backgroundColor: ' #e19c93' }}  onClick={handleNextPage}>Next</button>
          </div>
        </div>
      )}
      ...
      {currentPage === 3 && (
        <div>
          ...
          <div className="btn-container">
            <button type="button" style={{ backgroundColor: ' #e19c93' }}  className="btn-primary" onClick={handlePreviousPage}>
              Back
            </button>
            <button type="button" style={{ backgroundColor: ' #e19c93' }}  className="btn-primary" onClick={handleNextPage}>
              Next
            </button>
          </div>
        </div>
      ...
      {currentPage === 4 && (
        <div>
          ...
          <div className="btn-container">
            <button type="button" style={{ backgroundColor: ' #e19c93' }} className="btn-primary" onClick={handlePreviousPage}>Back</button>
          </div>
        </div>
      )}
    </div>
...
export default PregnancyCardViewMidwife;
