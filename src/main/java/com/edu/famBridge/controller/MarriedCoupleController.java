...
public class MarriedCoupleController {
    ...
    @Autowired
    private MarriedCoupleRepository marriedRepository;

    //Get couple by nic   -----used------
    @GetMapping("/getCoupleByNIC/{nic}")//ok
    public MarriedCoupleDTO getCoupleByNIC(@Valid @PathVariable String nic) {
        return marriedCoupleService.getCoupleByNic(nic);
    }
