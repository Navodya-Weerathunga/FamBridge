...
public class PregnancyCardDTO {
    ...
    private String poa;
    private PregnancyCard.Gravidity gravidity;
    ...
    public PregnancyCard.Gravidity getGravidity() {
        return gravidity;
    }

    public void setGravidity(PregnancyCard.Gravidity gravidity) {
