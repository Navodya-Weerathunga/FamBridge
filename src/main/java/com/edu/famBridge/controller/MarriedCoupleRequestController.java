...
@RestController
@RequestMapping(value = "famBridge/marriedCoupleRequest")
...
public class MarriedCoupleRequestController {
    ...
    @Autowired
    private MarriedCoupleRequestRepository marriedRegistrationRequestRepository;

    //Get request By ID

    @GetMapping("/getMarriedCoupleRequestByUniqueId/{requestId}")
    public ResponseEntity<MarriedCoupleRequestDTO> getMarriedCoupleRequestByUniqueId (@PathVariable long requestId){
        return ResponseEntity.ok(marriedCoupleRequestService.getMarriedCoupleRequestByUniqueId(requestId));
    }
